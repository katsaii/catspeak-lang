    ...
    if (db == undefined) {
        ...
        with ({ }) { // protects from incorrectly reading a missing function from an instance variable
            try {
               ...
               __catspeak_error_silent(__catspeak_cat("skipping GML API versions: fnames-2022-lts, fnames-2024-2-0-163 (your GameMaker version may be out of date) reason: ", __err.message));
            }
            try {
               ...
               __catspeak_error_silent(__catspeak_cat("skipping GML API versions: fnames-2022-lts (your GameMaker version may be out of date) reason: ", __err.message));
            }
            try {
               ...
               __catspeak_error_silent(__catspeak_cat("skipping GML API versions: fnames-2024-2-0-163 (your GameMaker version may be out of date) reason: ", __err.message));
            }
        }
    }
    return db;
