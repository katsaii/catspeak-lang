//! Contains a compatibility layer for help with converting projects from
//! Catspeak 3 to Catspeak 4. Specifically, for projects which still depend
//! on the old HIR format of Catspeak programs.
