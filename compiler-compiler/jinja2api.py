...
def gml_literal(type_name, value):
    return type_to_gml_literal(type_name, value)

@jinja2_export
def gml_literal_default(type_name):
    return type_to_gml_literal(type_name)

@jinja2_export
def gml_type_feather(type_name):
    return type_to_gml_feather(type_name)

@jinja2_export
def gml_type_buffer(type_name):
    return type_to_gml_buffer(type_name)