...
function catspeak_ext_gml_constants() {
	static vars = (function() {
		...
		_[$ "audio_old_system"] = audio_old_system;
		_[$ "audio_new_system"] = audio_new_system;
		...
		_[$ "phy_particle_data_flag_color"] = phy_particle_data_flag_color;
		...
		_[$ "vertex_usage_textcoord"] = vertex_usage_textcoord;
...
function catspeak_ext_gml_functions() {
	static vars = (function() {
		...
		_[$ "array_length_1d"] = array_length_1d;
		_[$ "array_length_2d"] = array_length_2d;
		_[$ "array_height_2d"] = array_height_2d;
		...
		_[$ "audio_resume_music"] = audio_resume_music;
		_[$ "audio_music_is_playing"] = audio_music_is_playing;
		_[$ "audio_resume_sound"] = audio_resume_sound;
		_[$ "audio_pause_sound"] = audio_pause_sound;
		_[$ "audio_pause_music"] = audio_pause_music;
		...
		_[$ "audio_play_music"] = audio_play_music;
		_[$ "audio_stop_music"] = audio_stop_music;
		_[$ "audio_master_gain"] = audio_master_gain;
		_[$ "audio_music_gain"] = audio_music_gain;
		...
		_[$ "room_set_background_colour"] = room_set_background_colour;
		_[$ "room_set_background_color"] = room_set_background_color;
		...
		_[$ "ads_disable"] = ads_disable;
		_[$ "ads_setup"] = ads_setup;
		_[$ "ads_engagement_launch"] = ads_engagement_launch;
		_[$ "ads_engagement_available"] = ads_engagement_available;
		_[$ "ads_engagement_active"] = ads_engagement_active;
		_[$ "ads_event"] = ads_event;
		_[$ "ads_event_preload"] = ads_event_preload;
		_[$ "ads_set_reward_callback"] = ads_set_reward_callback;
		_[$ "ads_get_display_height"] = ads_get_display_height;
		_[$ "ads_get_display_width"] = ads_get_display_width;
		_[$ "ads_move"] = ads_move;
		_[$ "ads_interstitial_available"] = ads_interstitial_available;
		_[$ "ads_interstitial_display"] = ads_interstitial_display;
		...
		_[$ "analytics_event"] = analytics_event;
		_[$ "analytics_event_ext"] = analytics_event_ext;
		_[$ "win8_livetile_tile_notification"] = win8_livetile_tile_notification;
		_[$ "win8_livetile_tile_clear"] = win8_livetile_tile_clear;
		_[$ "win8_livetile_badge_notification"] = win8_livetile_badge_notification;
		_[$ "win8_livetile_badge_clear"] = win8_livetile_badge_clear;
		_[$ "win8_livetile_queue_enable"] = win8_livetile_queue_enable;
		_[$ "win8_secondarytile_pin"] = win8_secondarytile_pin;
		_[$ "win8_secondarytile_badge_notification"] = win8_secondarytile_badge_notification;
		_[$ "win8_secondarytile_delete"] = win8_secondarytile_delete;
		_[$ "win8_livetile_notification_begin"] = win8_livetile_notification_begin;
		_[$ "win8_livetile_notification_secondary_begin"] = win8_livetile_notification_secondary_begin;
		_[$ "win8_livetile_notification_expiry"] = win8_livetile_notification_expiry;
		_[$ "win8_livetile_notification_tag"] = win8_livetile_notification_tag;
		_[$ "win8_livetile_notification_text_add"] = win8_livetile_notification_text_add;
		_[$ "win8_livetile_notification_image_add"] = win8_livetile_notification_image_add;
		_[$ "win8_livetile_notification_end"] = win8_livetile_notification_end;
		_[$ "win8_appbar_enable"] = win8_appbar_enable;
		_[$ "win8_appbar_add_element"] = win8_appbar_add_element;
		_[$ "win8_appbar_remove_element"] = win8_appbar_remove_element;
		_[$ "win8_settingscharm_add_entry"] = win8_settingscharm_add_entry;
		_[$ "win8_settingscharm_add_html_entry"] = win8_settingscharm_add_html_entry;
		_[$ "win8_settingscharm_add_xaml_entry"] = win8_settingscharm_add_xaml_entry;
		_[$ "win8_settingscharm_set_xaml_property"] = win8_settingscharm_set_xaml_property;
		_[$ "win8_settingscharm_get_xaml_property"] = win8_settingscharm_get_xaml_property;
		_[$ "win8_settingscharm_remove_entry"] = win8_settingscharm_remove_entry;
		_[$ "win8_share_image"] = win8_share_image;
		_[$ "win8_share_screenshot"] = win8_share_screenshot;
		_[$ "win8_share_file"] = win8_share_file;
		_[$ "win8_share_url"] = win8_share_url;
		_[$ "win8_share_text"] = win8_share_text;
		_[$ "win8_search_enable"] = win8_search_enable;
		_[$ "win8_search_disable"] = win8_search_disable;
		_[$ "win8_search_add_suggestions"] = win8_search_add_suggestions;
		_[$ "win8_device_touchscreen_available"] = win8_device_touchscreen_available;
		_[$ "win8_license_initialize_sandbox"] = win8_license_initialize_sandbox;
		_[$ "win8_license_trial_version"] = win8_license_trial_version;
		...
		_[$ "gml_release_mode"] = gml_release_mode;
		_[$ "gml_pragma"] = gml_pragma;
		...
		_[$ "vertex_format_add_textcoord"] = vertex_format_add_textcoord;
		...
		_[$ "skeleton_animation_get_event_frames"] = skeleton_animation_get_event_frames;
